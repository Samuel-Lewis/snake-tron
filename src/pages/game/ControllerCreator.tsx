...
import { BuiltInControllerFactory } from "../../controller/builtin/Selector";
...
const availableFactories: ControllerFactory[] = [
...
> = ({ onControllerChange, onNext }) => {
  ...
  return (
    <>
      ...
      <Divider />
      <Tooltip
        title="You must specify at least 2 controllers"
        placement="right"
      >
        <Button
          type="primary"
